...
namespace TheBugTracker.Services
{
    public class BTRolesService : IBTRolesService
    {
        ...
        public async Task<List<BTUser>> GetUsersNotInRoleAsync(string roleName, int companyId)
        {
            ...
            List<BTUser> result = roleUsers.Where(r => r.CompanyId == companyId).ToList();
        ...
        {
            bool removeUser = (await _userManager.RemoveFromRoleAsync(user, roleName)).Succeeded;
            return removeUser;
        }
        //----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
        public async Task<bool> RemoveUserFromRolesAsync(BTUser user, IEnumerable<string> roles)
        {
            bool removeUsers = (await _userManager.RemoveFromRolesAsync(user, roles)).Succeeded;
            return removeUsers;
        }
    }
}
